...
class ProductController {
  Future<void> uploadProduct({
    ...
    if (token == null) {
      showSnackBar2(context, "User not authenticated");
      return;
    }
    ...
    try {
      ...
      for (int i = 0; i < pickedImages.length; i++) {
        final response = await cloudinary.uploadFile(
          CloudinaryFile.fromBytesData(
            pickedImages[i],
            folder: productName, // folder named after product
            identifier: "image_$i.jpg", // unique name for each image
          ),
        );
      ...
      showSnackBar2(context, "Upload Failed");
    }
  }
  ...
  //       showSnackBar2(context, "Select Image");
  //       return;
  //     }
  ...
  //       //     showSnackBar2(context, errorMessage);
  //       //   }
  //       // }
  //     } else {
